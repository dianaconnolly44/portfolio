...
function setup() {
    ...
    // for (var i = 0; i<18; i++) {
    //     var L = (TextRainLetters[i],i*10,py);
    //     letters.push(L);
    // }
}


// var letter = makeTextRainLetter(a, 5, 5);
// letter.trlReset();
// letter.px = 3894;
...
function draw() {
    ...
    //loop that goes thru every letter, update and render
...
//words[i] = makeTextRainLetter(TextRainLetters[i],px,py);
