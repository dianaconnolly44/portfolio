    ...
    return (
      <div className="about">
        <div>
          ...
          <div className="body">
            <p>I have a passion to use my art for <b className="blue">education</b> (e.g. animated <a onClick={e => nav("/videos")}>explainer videos</a>, educational and literacy-oriented <a onClick={e => nav("/childrens")}>children's books</a>, digital <a onClick={e => nav("/childrens#expii")}>graphics</a> for an e-learning site), and <b className="pink">communication</b> (e.g. animated <a onClick={e => nav("/loops")}>gifs</a> to convey a topic visually, <a onClick={e => nav("/iconography")}>communication symbols</a> for nonverbal individuals, <a onClick={e => nav("/media")}>editorial illustrations</a> for news and other media).</p>
