        ...
        <div>
          <div className="top">
            ...
            <div className="header">
              ...
              <div style={{ marginBottom: -5 }}>
                ...
                I'm a <b className="pink">creative</b> in NYC applying for eCornell's position in <b className="blue">illustration</b>.
              </div>
            </div>
          </div>
          ...
          <div className="body">
            ...
            <ul className="blue">
              ...
              <li><a onClick={e => nav("/childrens")}>educational children's illustrations <span className="arrow">➜</span></a></li> 
