...
export const Page = props => (
  <div className="project">
    ...
    <h1> Digital Color Study: Triad </h1>

    
    <div className="imgs max700">
        <div>
            <img src={require('../assets/drawing/colorTriad.jpg')} />
        </div>
    </div>
    ...
    Studio". The assignment was to incorporate a "color triad" palette into an image. A "color triad" is defined as a color scheme that 
    utilizes a special variant of the split-complementary color scheme, with equal distance between the colors on the color wheel. 
    All three colors being distributed evenly around the color wheel causes there to be no clear dominance of one color. I thought 
    this phenomena is well exhibited in tropical birds, who can naturally exhibit such opposing colors.</p>
