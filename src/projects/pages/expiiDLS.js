...
export const Page = props => (
  <div className="project">
    ...
    <div className="imgs max600">
      <div>
        <img src={require('../assets/expiiGIFs/clockFinal.gif')} />
      </div>
    </div>
...
If the web-page is broken, click <a target="_blank" href={require('../assets/expiiGIFs/dls.jpg')}>here</a> to view a screen capture of what the page looked like.</p>
    
    <br />

    <iframe 
      src="https://www.expii.com/t/what-is-a-percent-9062?type=problem&id=18056" 
