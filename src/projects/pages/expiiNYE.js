...
<div className="imgs max600">
            <div>
                <img src={require('../gallery/expiiGIFs/nyeBig.gif')} />
            </div>
    </div>
...
If the web-page is broken, click <a target="_blank" href={require('../gallery/expiiGIFs/NYE.png')}>here</a> to view a screen capture of what the page looked like.</p>
   <br />
