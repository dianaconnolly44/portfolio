...
If the web-page is broken, click <a target="_blank" href={require('../assets/expiiGIFs/ornaments.png')}>here</a> to view a screen capture of what the page looked like.</p>
   <br />
