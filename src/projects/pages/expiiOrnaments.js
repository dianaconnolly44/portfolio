...
<div className="imgs max600">
            <div>
                <img src={require('../gallery/expiiGIFs/ornaments-sm.gif')} />
            </div>
    </div>
...
If the web-page is broken, click <a target="_blank" href={require('../gallery/expiiGIFs/ornaments.png')}>here</a> to view a screen capture of what the page looked like.</p>
   <br />
<iframe src="https://www.expii.com/t/word-problems-4278?type=problem&id=18300" title="Pumpkin Overload"></iframe>
