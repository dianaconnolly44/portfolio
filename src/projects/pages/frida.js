...
export const page = (
  <div className="project">
    ...
    <div className="imgs max600">
        <div>
            <img src={require('../assets/childrensIllos/frida/1.png')} />
    ...
    <div className="imgs max600">
        <div>
            <img src={require('../assets/childrensIllos/frida/2.png')} />
    ...
    <div className="imgs max600">
        <div>
            <img src={require('../assets/childrensIllos/frida/5.png')} />
    ...
    <div className="imgs max600">
        <div>
            <img src={require('../assets/childrensIllos/frida/7.png')} />
