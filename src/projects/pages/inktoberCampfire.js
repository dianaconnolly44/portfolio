...
export const Page = props => (
  <div className="project">
    ...
    <h1> Giftober 2020: "Campfire" </h1>

    <div className="imgs max600">
      <div>
        <img src={require('../assets/inktoberGIFs/inktoberCampfire.gif')} />
      </div>
    </div>
...
<p>The prompt for this specific GIF was "Campfire". My original post can be viewed <a href="https://www.instagram.com/p/CGGtyrhnmA8/" target="_blank">here</a>.</p>
