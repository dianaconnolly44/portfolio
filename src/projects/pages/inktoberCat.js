...
export const Page = props => (
  <div className="project">
    ...
    <h1> Giftober 2020: "Black Cat" </h1>

    <div className="imgs max600">
      <div>
        <img src={require('../assets/inktoberGIFs/inktoberCat.gif')} />
      </div>
    </div>
...
<p>The prompt for this specific GIF was "Black Cat", and I gave it the caption "Peek-a-boo 👀". My original post can be viewed <a href="https://www.instagram.com/p/CGcgcQXHEFC/" target="_blank">here</a>.</p>
