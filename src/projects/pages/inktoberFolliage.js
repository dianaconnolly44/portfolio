...
export const Page = props => (
  <div className="project">
    ...
    <h1> Giftober 2020: "Fall Folliage" </h1>

    <div className="imgs max600">
      <div>
        <img src={require('../assets/inktoberGIFs/inktoberFolliage.gif')} />
      </div>
    </div>
...
<p>The prompt for this specific GIF was "Fall Folliage", and I gave it the caption "Unbe-leaf-able!". My original post can be viewed <a href="https://www.instagram.com/p/CF8RJb8HE6G/" target="_blank">here</a>.</p>
