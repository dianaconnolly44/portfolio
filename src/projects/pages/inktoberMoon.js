...
export const Page = props => (
  <div className="project">
    ...
    <h1> Giftober 2020: "Harvest Moon" </h1>

    <div className="imgs max600">
      <div>
        <img src={require('../assets/inktoberGIFs/inktoberMoon.gif')} />
      </div>
    </div>
...
<p>The prompt for this specific GIF was "Harvest Moon", and I gave it the caption "Tallest kid in class". My original post can be viewed <a href="https://www.instagram.com/p/CFzmJbzn67S/" target="_blank">here</a>.</p>
