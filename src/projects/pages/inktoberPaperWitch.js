...
export const Page = props => (
  <div className="project">
    ...
    <div className="imgs max600">
      <div>
        <img src={require('../assets/inktoberGIFs/inktoberPaperWitch.gif')} />
      </div>
    </div>
...
<p>The prompt for this specific GIF was "Witch". My original post can be viewed <a href="https://www.instagram.com/p/CGU08ggnvPv/" target="_blank">here</a>.</p>
