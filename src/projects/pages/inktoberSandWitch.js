...
export const Page = props => (
  <div className="project">
    ...
    <h1> Giftober 2020: "Witch" </h1>

    <div className="imgs max600">
      <div>
        <img src={require('../assets/inktoberGIFs/inktoberSandWitch.gif')} />
      </div>
    </div>
...
<p>The prompt for this specific GIF was "Witch", and I gave it the caption "Sand-witch!" My original post can be viewed <a href="https://www.instagram.com/p/CGDIvmqHhP5/" target="_blank">here</a>.</p>
