...
export const Page = props => (
  <div className="project">
    ...
    <h1> Giftober 2020: "Scarecrow" </h1>

    <div className="imgs max600">
      <div>
        <img src={require('../assets/inktoberGIFs/inktoberScarecrow.gif')} />
      </div>
    </div>
...
<p>The prompt for this specific GIF was "Scarecrow", and I gave it the caption "A scarecrow who can’t scare crows". My original post can be viewed <a href="https://www.instagram.com/p/CGv1NNJHJ_t/" target="_blank">here</a>.</p>
