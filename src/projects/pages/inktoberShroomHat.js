...
export const Page = props => (
  <div className="project">
    ...
    <h1> Giftober 2020: "Mushroom" </h1>

    <div className="imgs max600">
      <div>
        <img src={require('../assets/inktoberGIFs/inktoberShroomHat.gif')} />
      </div>
    </div>
...
<p>The prompt for this specific GIF was "Mushroom", and I gave it the caption "Hats off to ya". My original post can be viewed <a href="https://www.instagram.com/p/CF-fITFHCQV/" target="_blank">here</a>.</p>
