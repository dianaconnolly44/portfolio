...
export const Page = props => (
  <div className="project">
    ...
    <div className="imgs max600">
      <div>
        <img src={require('../assets/inktoberGIFs/inktoberShroomPizza.gif')} />
      </div>
    </div>
...
<p>The prompt for this specific GIF was "Mushroom", and I gave it the caption "🍄🍕, anyone?". My original post can be viewed <a href="https://www.instagram.com/p/CGPs3UNH-Dm/" target="_blank">here</a>.</p>
