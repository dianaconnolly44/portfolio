...
export const Page = props => (
  <div className="project">
    ...
    <h1> Giftober 2020: "Cozy Sweater" </h1>

    <div className="imgs max600">
      <div>
        <img src={require('../assets/inktoberGIFs/inktoberSweater.gif')} />
      </div>
    </div>
...
<p>The prompt for this specific GIF was "Cozy Sweater". My original post can be viewed <a href="https://www.instagram.com/p/CGfzHGinVQx/" target="_blank">here</a>.</p>
