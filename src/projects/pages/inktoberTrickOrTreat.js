...
export const Page = props => (
  <div className="project">
    ...
    <h1> Giftober 2020: "Trick or Treat" </h1>

    <div className="imgs max600">
      <div>
        <img src={require('../assets/inktoberGIFs/inktoberTrickOrTreat.gif')} />
      </div>
    </div>
...
<p>The prompt for this specific GIF was "Trick or Treat". My original post can be viewed <a href="https://www.instagram.com/p/CG_dieGnQ4m/" target="_blank">here</a>.</p>
