...
export const page = (
  <div className="project">
    ...
    <div className="imgs max700">
        <div>
            <img src={require('../gallery/childrensIllos/seasonsOfColor/fallOrange.png')} />
    ...
    <div className="imgs max700">
        <div>
            <img src={require('../gallery/childrensIllos/seasonsOfColor/winterWhite.png')} />
    ...
    <div className="imgs max700">
        <div>
            <img src={require('../gallery/childrensIllos/seasonsOfColor/springGreen.png')} />
    ...
    <div className="imgs max700">
        <div>
            <img src={require('../gallery/childrensIllos/seasonsOfColor/summerBlue.png')} />
